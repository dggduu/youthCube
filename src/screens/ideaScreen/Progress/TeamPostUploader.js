...
import { View, Text, TouchableOpacity, TextInput, ActivityIndicator, Image, ScrollView, Modal, Platform } from 'react-native';
            ...
            <ScrollView className="flex-1 p-5">
                ...
                <TouchableOpacity
                    ...
                    className={`p-4 rounded-lg items-center mb-10 ${
                        isUploading || (Date.now() - lastSubmitTimeRef.current < 5000) ? 'bg-gray-300' : 'bg-[#409eff]'
                    }`}
                >
